...
def main():
    parser = argparse.ArgumentParser(
        ...
        $ python view.py test/problem2.json test/bfs.path
        this will view the problem instance 'test/problem2.json', and superimpose
        the path 'test/bfs.path' on top of both views.

        $ python view.py test/problem2.json test/*.path
        this will view the problem instance 'test/problem2.json', and superimpose
