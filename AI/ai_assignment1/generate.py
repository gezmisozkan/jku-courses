...
def main():
    parser = argparse.ArgumentParser(
        ...
        $ python generate.py maze 10 test/problem2.json
        this generates a random 10x10 board in the shape of a maze,
        and writes the problem instance into the file 'test/problem2.json'.

        $ python generate.py terrain 50 test/problem2.json
